...
import com.example.OpenSource.domain.auth.domain.oauth.OAuthApiClient;
...
public class KakoApiClient implements OAuthApiClient {
    ...
    public OAuthInfoResponse requestOauthInfo(String accessToken) {
        ...
        body.add("property_keys",
                "[\"kakao_account.email\",\"kakao_account.profile\",\"kakao_account.profile.profile_image_url\"]");
